...
var appdw1 = '/*<div class="layui-waper"><div class="layer-iframe"><div class="layer-content layer_notice"><a href="javascript:;" class="close">跳过</a><a href="javascript:;" class="link">下载APP</a></div></div></div>*/';
(function() {
    if (!isWeiXin()) {
...
var appdw2 = '<div class="layer-shade"></div><div class="layui-layer"><div class="layer-wraper anim-scale"><div class="layer-poster"><a href="/" target="_blank"></a></div><div class="layer-content"><span class="layer-title">下载APP</span><p>扫码下载APP,随时随地看片看直播</p><div class="code"></div><a class="link" href="javascript:;"  target="_blank">参观一下</a><a class="close" href="javascript:;"></a></div></div></div>';
(function() {
    if (!isWeiXin()) {
